...
# path to data
path_to_data = "/media/oana/Data1/Annular_Eclipse_Analysis/Data/"
path_to_save_figures = "/media/oana/Data1/Annular_Eclipse_Analysis/Figures/"
path_to_save_wave_results = "/media/oana/Data1/Annular_Eclipse_Analysis/Results/"

# If folder doesn't exist, create it
if not os.path.isdir(path_to_save_figures):
    os.mkdir(path_to_save_figures)

if not os.path.isdir(path_to_save_wave_results):
    os.mkdir(path_to_save_wave_results)
...
for nom in tqdm(range(0,sequence_end),desc="Looping through all identified local maxima"):
    ...
    # Append a row corresponding to the current wave packet being analyzed each loop iteration
